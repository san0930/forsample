  ...
  return (
    <div className="px-4 md:px-6 py-10">
      <div className="text-center mb-6">
        ...
        >
          Sila maraka mudiyatha pictures!
        </motion.h2>
        <p className="text-sm text-rose-100/90 mt-1">Enaku pudicha pics😌  (unaku kandipa pudikathu🤣)</p>
      </div>
      ...
      >
        <GradientButton onClick={onNext}>
          <Mail size={20} className="mt-0.5" /> Unaku oru message irukku!
        </GradientButton>
      </motion.div>
    </div>
  )
